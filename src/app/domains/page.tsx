...
const POPULAR_TLDS = [
  ...
  { tld: "net", name: ".net", price: 14.99 },
  { tld: "org", name: ".org", price: 12.99 },
  { tld: "io", name: ".io", price: 39.99, popular: true },
  { tld: "co", name: ".co", price: 29.99 },
  { tld: "ai", name: ".ai", price: 79.99, hot: true },
  { tld: "app", name: ".app", price: 19.99 },
  { tld: "dev", name: ".dev", price: 16.99 },
  { tld: "tech", name: ".tech", price: 9.99 },
  { tld: "online", name: ".online", price: 4.99 },
  { tld: "store", name: ".store", price: 4.99 },
  { tld: "shop", name: ".shop", price: 4.99 },
  { tld: "xyz", name: ".xyz", price: 2.99 },
  { tld: "site", name: ".site", price: 3.99 },
  { tld: "cloud", name: ".cloud", price: 12.99 },
...
const FOOTER_SECTIONS: FooterSection[] = [
  { title: "DOMAINS", links: [{ label: "Domain Search", href: "/domains" }, { label: "Domain Transfer", href: "/domains/transfer" }] },
